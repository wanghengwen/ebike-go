...
import com.luopingtech.ebike.ops.ui.map.OpsScatterMapSpec
import com.luopingtech.ebike.ops.ui.map.OpsScatterMapView
        ...
        Box(modifier = Modifier.weight(1f).fillMaxWidth()) {
            OpsScatterMapView(
                spec = OpsScatterMapSpec(
                    ...
                    // 厂商散点能力缺席时降级成普通车点图
                    fallbackPins = state.visiblePoints.mapIndexed { i, p ->
                        MapPin(
                            id = "rc-$i",
                            lat = p.lat,
                            lng = p.lng,
