...
class RequestAuth(
    ...
    private fun applyCommon(
        ...
        builder.header(HttpHeaders.AcceptLanguage, com.luopingtech.ebike.ops.core.i18n.LocaleContext.acceptLanguage)
...
class HttpClientFactory(
    private val config: TenantConfig,
    private val opsLogger: OpsLogger,
) {
    val json: Json = Json {
