...
// DevicePaasClient uses a longer timeout for ECU/device queries. Java Feign to
// ebike-device-paas waits for ecu/wild (~25s); the default 10s client caused Go
// to fail early in shadow compare while Java still succeeded.
